...
#define MEM_SUPERVISOR_MEMORY_SIZE 256
...
#define MEM_PAGE_COUNT 69
#define MEM_PAGE_SIZE 16
#define MEM_USER_PAGE_COUNT 51

#define MEM_MAX_ADDRESS 0x1140
...
#define MEM_MAX_ADDRESS_LENGTH 4
#define MEM_BAD_ADDRESS_ERR "Maximum address exceeded\n" 
#define MEM_BEG_SUPERVISOR_ADDR 0xd40
#define MEM_WORDS_SUPERVISOR_COUNT 256
#define MEM_SUPERVISOR_PAGE_COUNT 16
#define MEM_SUPERVISOR_PAGE_BEGIN 0x35

#define MEM_PAGE_BYTE_COUNT MEM_PAGE_SIZE * MEM_WORD_SIZE
